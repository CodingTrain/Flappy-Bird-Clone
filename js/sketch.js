...
function preload() {
  ...
  pipePeakSprite = loadImage(host+'graphics/pipe_marshmallow_fix.png');
  birdSprite = loadImage(host+'graphics/train.png');
  bgImg = loadImage(host+'graphics/background.png');

  tfWorker = new Worker(host+"js/tfWorker.js");
}
